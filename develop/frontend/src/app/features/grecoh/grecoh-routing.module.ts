...
const routes: Routes = [
  ...
  { path: 'scoresAnalysis/:id', component: GrecohPaintingAnalysisComponent, canActivate: [AuthGuard] },
  { path: 'questionsAnalysis', component: QuestionsAnalysisComponent, canActivate: [AuthGuard] },
